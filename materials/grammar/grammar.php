...
<body>
    ...
    <div class="container-fluid py-5 materials">
        <div class="title-section">
            <h3>Grammar Guide</h3>
            <p>Grammar in English encompasses a set of rules governing sentence structure, word formation, and punctuation usage. It ensures clarity and precision in communication. Key elements include understanding parts of speech such as nouns, verbs, adjectives, and adverbs. English sentences typically consist of a subject and a predicate, with various types like declarative, interrogative, imperative, and exclamatory. Verb tenses indicate when actions occur, while articles and determiners specify nouns. Pronouns replace nouns, subject-verb agreement ensures coherence, and modifiers provide additional information. Conjunctions connect words, prepositions indicate relationships, and punctuation marks aid in clarity. Mastery of English grammar is essential for effective communication, facilitating accurate expression and comprehension.</p>
        </div>
            ...
            <div class="col-6">
                <div class="card mb-3" style="max-width: 600px;">
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title text-center" style="color: #8671e1;">Grammar Guide Part One</h5>
                                <p class="card-text">In the first part of the grammar guide we will learn about Pronouns and the Use of To Be</p>
            ...
            <div class="col-6">
                <div class="card mb-3" style="max-width: 600px;">
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title text-center" style="color: #8671e1;">Grammar Guide Part Two</h5>
