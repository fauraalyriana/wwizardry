...
<body>
    ...
    <div class="container-fluid py-5 materials2">
        <div class="title-section">
            <h3>Writing Corner</h3>
            <p>Effective writing in English requires a combination of grammatical proficiency, clarity, and creativity. Grammar serves as the structural foundation, ensuring coherent and well-organized sentences. It involves understanding sentence construction, verb tenses, and proper use of punctuation. Building a diverse vocabulary is equally crucial, enabling writers to convey ideas with precision and nuance.
                Furthermore, successful writing involves the art of articulating thoughts logically. Organizing ideas into well-structured paragraphs, with a clear introduction, body, and conclusion, enhances overall readability. Engaging in the revision process to refine and polish the content is essential. Additionally, developing a distinctive writing style and adapting it to different contexts adds a personal touch to one's work. Continuous practice, coupled with feedback from peers or mentors, contributes to the ongoing improvement of writing skills. Ultimately, effective writing is a blend of technical proficiency, creativity, and the ability to connect with readers through clear and impactful communication.</p>
        </div>
            ...
            <div class="col-6">
                <div class="card mb-3" style="max-width: 600px;">
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title text-center" style="color: #8671e1;">Writing Corner Part One</h5>
                                <p class="card-text">In the first part we will learn about Introduction to Writing Skills</p>
            ...
            <div class="col-6">
                <div class="card mb-3" style="max-width: 600px;">
                    <div class="row g-0">
                        ...
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title text-center" style="color: #8671e1;">Writing Corner Part Two</h5>
